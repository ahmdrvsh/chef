  ...
  return (
    <div className="max-w-md mx-auto bg-white dark:bg-stone-800 p-10 rounded-3xl shadow-sm border border-stone-100 dark:border-stone-700 mt-16">
      <div className="text-center mb-10">
        ...
        <h2 className="text-3xl font-extrabold text-stone-800 dark:text-stone-100 tracking-tight">ورود به حساب</h2>
      </div>
      ...
      <p className="text-center mt-8 text-sm text-stone-500 dark:text-stone-400">
        حساب کاربری ندارید؟ <Link to="/register" className="text-rose-500 font-bold hover:underline mx-1">ثبت‌نام کنید</Link>
      </p>
    </div>
  );
}
