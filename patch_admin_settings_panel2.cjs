...
const oldEnd = `      {activeTab === 'comments' && (
        <div className="bg-white dark:bg-stone-800 p-6 rounded-2xl shadow-sm border border-gray-100 dark:border-stone-700">`;

const newPanel = `      {activeTab === 'settings' && (
        <div className="bg-white dark:bg-stone-800 p-6 rounded-3xl shadow-sm border border-gray-100 dark:border-stone-700 mb-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            ...
            <div className="space-y-4">
              {selectedAdminCategory ? (
                ...
                <div className="h-full flex items-center justify-center text-gray-400 border-2 border-dashed border-gray-200 dark:border-stone-700 rounded-xl min-h-[100px]">
